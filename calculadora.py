...
def calculadora():
    calc = input("Escolha a função: Soma, Menos , Dividir, Multiplicar, Porcentangem, Potencia: ")
    calc.lower()
    if calc == "soma":
        ...
        print(div(a, b))
    elif calc == "multiplicar":
        a = float(input("Qual o primeiro numero: "))
        b = float(input("Qual o segundo numero: "))
        print(mult(a, b))
    elif calc == "porcentagem":
        a = float(input("Qual o numero: "))
        b = float(input("Qual sua porcentagem numero: "))
        print(porcentagem(a, b))
    elif calc == "potencia":
        a = int(input("Qual o primeiro numero (base): "))
        b = int(input("Qual o segundo numero (expoente): "))
        print(potencia(a, b))
    else:
        print("Erro")
        return calculadora()
